...
public class ReportsGUI {
    ...
    private void addNavigationItems() {
        ...
        inventory.setItem(plugin.getConfigManager().getReportsPreviousPageSlot(), null);
        inventory.setItem(plugin.getConfigManager().getReportsNextPageSlot(), null);
        
        if (currentPage > 0) {
            ItemStack previousPage = new ItemStack(Material.ARROW);
            ItemMeta meta = previousPage.getItemMeta();
            meta.setDisplayName(plugin.getLanguageManager().getMessage("gui.report-player.previous-page"));
        ...
        if (currentPage < totalPages - 1) {
            ...
            meta.setDisplayName(plugin.getLanguageManager().getMessage("gui.report-player.next-page"));
