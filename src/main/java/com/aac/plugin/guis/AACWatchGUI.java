...
public class AACWatchGUI {
    ...
    private void addNavigationItems() {
        ...
        inventory.setItem(plugin.getConfigManager().getAACWatchPreviousPageSlot(), null);
        inventory.setItem(plugin.getConfigManager().getAACWatchNextPageSlot(), null);
        
        if (currentPage > 0) {
            ItemStack previousPage = new ItemStack(Material.ARROW);
            ItemMeta meta = previousPage.getItemMeta();
            meta.setDisplayName(plugin.getLanguageManager().getMessage("gui.aacwatch.previous-page"));
        ...
        if (currentPage < totalPages - 1) {
            ...
            meta.setDisplayName(plugin.getLanguageManager().getMessage("gui.aacwatch.next-page"));
